        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if( $field6name == 1){
                echo '<div class="tabla hover">
                      ...
                      <img src="images/abarrotes/'.$field4name.'.jpg"/ alt="imagen no disponible" style="width:170px;height:170px;">
                      <h3> <sup></sup></h3>
                      <h4 style="color:red;">'.$field5name.' '.$field2name.'</h4>
                      <h1 style="color:red;"> $'.$field3name.'</h1>
                      </div>';
            }else{
                echo '<div class="tabla hover">
                      <h2>'.$field1name.'</h2>
